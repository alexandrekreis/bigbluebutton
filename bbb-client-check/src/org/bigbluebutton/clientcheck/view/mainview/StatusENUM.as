...
package org.bigbluebutton.clientcheck.view.mainview
{
	...
	public class StatusENUM {
		...
		public static const SUCCEED:Object = {StatusMessage: ResourceManager.getInstance().getString('resources', 'bbbsystemcheck.status.success'), StatusPriority: 4};

		public static const CLIENT_CHECK_SUCCEEDED:int = 1;
		public static const CLIENT_CHECK_FAILED:int = 2;
		public static const CLIENT_CHECK_WARNING:int = 3;
	}
}
